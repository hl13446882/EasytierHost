...
pub trait ConfigLoader: Send + Sync {
    ...
    fn get_dhcp_range(&self) -> Option<DhcpRange>;
    fn set_dhcp_range(&self, range: Option<DhcpRange>);
...
impl ConfigLoader for TomlConfigLoader {
    ...
    fn get_dhcp_range(&self) -> Option<DhcpRange> {
        self.config.lock().unwrap().dhcp_range.clone()
    }
    fn set_dhcp_range(&self, range: Option<DhcpRange>) {
        self.config.lock().unwrap().dhcp_range = range;
    }
    fn get_dhcp(&self) -> bool {
